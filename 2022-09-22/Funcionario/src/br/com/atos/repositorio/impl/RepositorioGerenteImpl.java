...
public class RepositorioGerenteImpl implements RepositorioGerenteInterface{
    ...
    public void salvarGerente(Gerente gerente) {
        try{
            ...
            JOptionPane.showMessageDialog(null, "Funcionário "+gerente.getCpf()+" cadastrado com sucesso!!");
            
        }
        catch (Exception exception){
        	JOptionPane.showMessageDialog(null, "Não foi possível salvar Funcionário "+gerente.getCpf());
        }
    }
