...
public class TelaListaAlterar {
	...
	public void alterar(JTextField opcaoMenuJTextField, JFrame frameMenuInicial, RepositorioGerenteImpl repositorioGerenteImpl) {
		...
		paneldeletarGerente.add(botaoAlterar);
		...
		botaoAlterar.addActionListener(menuDeleteControle);
		
		ControleAlterar menu = new ControleAlterar(opcaoCpfTextField, frameDeletaGerente, frameMenuInicial, repositorioGerenteImpl,tabelaFuncionario);
